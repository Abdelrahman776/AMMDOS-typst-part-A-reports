...
#figure(caption: ['Ilm's stylingff], si-table)
...
= Code
== Custom formatting
'Ilm uses the _Iosevkafont for raw text instead of the default _Fira Mono. If Iosevka is not installed then the template will fall back to Fira Mono.
